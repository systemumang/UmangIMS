        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse text-sm">
            <thead className="bg-surface-container-high text-[10px] uppercase tracking-wider text-on-surface-variant font-bold">
              <tr>
                <th className="p-3 border-b border-r border-black">Return No</th>
                <th className="p-3 border-b border-r border-black">Return Date</th>
                <th className="p-3 border-b border-r border-black">Return Type</th>
                <th className="p-3 border-b border-r border-black">Customer Name</th>
                ...
                <th className="p-3 border-b border-r border-black">Received By</th>                <th className="p-3 border-b border-r border-black text-right">Total Items</th>
