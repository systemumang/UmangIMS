...
export default function DamageMasterView() {
  ...
  const sorted = [...filtered].sort((a, b) => {
    ...
    switch (sortBy) {
      ...
      case 'approvedBy':
        return dir * strCmp(String(a.approvedBy ?? ''), String(b.approvedBy ?? ''));
      case 'firm':
              ...
              <tr>
                <th className="p-0 border-b border-r border-black">
                  <button type="button" onClick={() => onSort('transactionNo')} className="w-full px-3 py-3 flex items-center justify-between">
                    <span>Damage No</span><ArrowUpDown size={12} />
                  </button>
                </th>
                <th className="p-0 border-b border-r border-black">
                  <button type="button" onClick={() => onSort('date')} className="w-full px-3 py-3 flex items-center justify-between">
                    <span>Damage Date</span><ArrowUpDown size={12} />
                  </button>
                </th>
                <th className="p-0 border-b border-r border-black">
                  <button type="button" onClick={() => onSort('approvedBy')} className="w-full px-3 py-3 flex items-center justify-between">
                    <span>Approved By</span><ArrowUpDown size={12} />
                  </button>
                </th>
                <th className="p-0 border-b border-r border-black">
                ...
                <th className="p-0 border-b border-r border-black">
                  <button type="button" onClick={() => onSort('person')} className="w-full px-3 py-3 flex items-center justify-between">
                    <span>Damage By</span><ArrowUpDown size={12} />
                  </button>
                </th>
