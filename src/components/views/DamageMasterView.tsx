...
import { listDamages, deleteDamage, type StockTransaction } from '@/src/lib/stockMaster';
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse text-sm">
            <thead className="bg-surface-container-high text-[10px] uppercase tracking-wider text-on-surface-variant font-bold">
              <tr>
                <th className="p-3 border-b border-outline-variant">Damage No</th>
                <th className="p-3 border-b border-outline-variant">Damage Date</th>
                <th className="p-3 border-b border-outline-variant">Firm</th>
                <th className="p-3 border-b border-outline-variant">Department</th>
                <th className="p-3 border-b border-outline-variant">Damaged By</th>
          ...
          <div className="bg-surface-container-lowest rounded-xl shadow-xl w-full max-w-2xl flex flex-col max-h-[90vh]">
            ...
            <div className="p-5 overflow-auto space-y-6">
              <div className="grid grid-cols-2 gap-4 text-sm bg-surface-container-low p-4 rounded-xl border border-outline-variant">
                ...
                <div><span className="font-bold text-[10px] uppercase text-on-surface-variant tracking-wider block mb-1">Damaged By</span> {viewItem.person}</div>
              </div>
