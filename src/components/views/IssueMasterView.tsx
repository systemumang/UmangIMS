...
import { listIssues, deleteIssue, type StockTransaction } from '@/src/lib/stockMaster';
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse text-sm">
            <thead className="bg-surface-container-high text-[10px] uppercase tracking-wider text-on-surface-variant font-bold">
              <tr>
                <th className="p-3 border-b border-outline-variant">Issue No</th>
                <th className="p-3 border-b border-outline-variant">Issue Date</th>
                <th className="p-3 border-b border-outline-variant">Issue Type</th>
                <th className="p-3 border-b border-outline-variant">Issued To</th>
                <th className="p-3 border-b border-outline-variant">Firm</th>
                <th className="p-3 border-b border-outline-variant">Department</th>
                <th className="p-3 border-b border-outline-variant">Issued By</th>
            ...
            <tbody className="divide-y divide-outline-variant">
              ...
              {filtered.map(row => (
                <tr key={row.id} className="hover:bg-surface-container-low/50 transition-colors">
                  ...
                  <td className="p-3 text-on-surface-variant">{row.issueType ?? 'Stock'}</td>
                  <td className="p-3 text-on-surface-variant">{row.issuedTo ?? '-'}</td>
