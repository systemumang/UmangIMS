	  ...
	  return (
	    <div className="space-y-6">
	      ...
	      <div className="hidden">
	        <div className="text-sm text-on-surface-variant">Check Quality</div>
	        <ExportCsvButton id="pending-export-btn" filename={`queue-qc-${new Date().toISOString().slice(0, 10)}.csv`} rows={rows} disabled={loading} />
	      </div>
        ...
        <QueueCard title="Check Quality" subtitle={`${rows.length} pending`} hideHeader>
