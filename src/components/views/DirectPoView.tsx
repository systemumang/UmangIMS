              ...
              {poType === 'Goods' ? (
                <div className="min-w-[1920px]">
                  <div
                    ...
                    style={{ gridTemplateColumns: `280px repeat(${specColumnIds.length || 1}, 220px) 220px 70px 100px 100px 70px 80px 120px 100px 100px ${supplierHasGst ? '90px 100px ' : ''}150px 100px 90px` }}
                  >
